...
const TOUR_WAYPOINTS = [
    { pos: [0, 0, 0], label: '🏠 ยินดีต้อนรับสู่ DJI 13Store!\nนี่คือ ลานกลาง — จุดเริ่มต้นการเดินทาง', duration: 4000 },
    { pos: [25, 0, -5], label: '🏪 ร้าน DJI Store 1\nชมโดรนรุ่นใหม่ล่าสุด Mini 4 Pro, Mavic 3 Pro', duration: 5000 },
    { pos: [25, 0, -30], label: '🏪 ร้าน DJI Store 2\nสัมผัส Avata 2 และ Air 3 ได้ที่นี่', duration: 5000 },
    { pos: [-15, 0, -40], label: '🏟️ FPV Racing Arena\nทดสอบบินโดรน FPV ผ่านสนามแข่ง!', duration: 4000 },
    { pos: [-55, 0, 25], label: '🏢 ห้องประชุม Meeting Hall\nกด M เพื่อเข้าร่วมวิดีโอคอล\nกด B เพื่อเปิด Whiteboard', duration: 5000 },
    { pos: [0, 0, 0], label: '🎉 จบทัวร์แล้ว!\nสนุกกับ DJI 13Store ได้เลยครับ', duration: 3000 },
];
